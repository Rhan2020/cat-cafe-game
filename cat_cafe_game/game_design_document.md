...
*   **核心角色设定：**
    *   **主人（玩家）：** 可自定义性别和昵称。是咖啡馆的决策者，动物们的依靠和伙伴。
    *   **动物员工：** 游戏的核心收集对象。以猫咪为主体，同时包含少数稀有的、同样"萌系"的狗狗和鼠鼠（仓鼠/龙猫等）作为特殊角色。每个物种都有独特的个性和专属的技能。
...
*   **物种与专属岗位：**
    *   **猫咪 (Cats):** 核心员工，可胜任【吧台】、【后厨】、【外卖】等所有常规岗位。
    *   **狗狗 (Dogs):** 特殊员工，仅可被分配到【迎宾】或【保安】岗位，拥有提升客流、维持秩序等特殊技能。
    *   **鼠鼠 (Mice/Hamsters):** 特殊员工，仅可被分配到【甜品研发】岗位，拥有研发特殊甜品、提升稀有食材掉率等专属技能。
*   **属性：** 烘焙、咖啡、速度、魅力、幸运、精力。
*   **技能：** 每个动物可拥有1-3个技能（如"订单暴击"、"顾客盈门"、"永不迷路"）。
...
*   **排行榜：** 财富榜、猫咪战力榜、渔王榜等。
*   **定向邀请与角色绑定（契约系统）：**
    *   **核心理念：** 将邀请行为与情感角色扮演深度绑定，创造独一无二的社交裂变钩子。
    *   **实现方式：** 玩家可以生成特殊的"契约邀请"。在生成时，可从预设的模板中选择一种进行绑定，例如：
        *   **【忠犬男友契约】:** 绑定一只"保安"属性的狗狗。邀请文案可以是："我的咖啡馆还缺一个守护神，你愿意来吗？"
        *   **【甜心闺蜜契约】:** 绑定一只"甜品研发"属性的仓鼠。邀请文案可以是："我的甜品台，永远为你留一个位置。"
    *   **效果：** 被邀请者通过此专属链接/卡片进入游戏，在开局时必定获得契约绑定的动物角色和一份特殊资源。同时，双方在游戏内自动建立"羁绊"关系，拥有特殊的好友标识。
...
### 4.8 特殊访客事件（社会关怀系统）
*   **核心原则（寓言化处理）：** 为表达对现实世界的深层关怀，同时规避所有潜在的政治与审核风险，我们将采用"寓言化"的艺术手法。通过创造游戏世界观内的、具有象征意义的特殊访客，来影射现实中的社会议题（如贫困、战争、环境问题等），引导玩家进行关于善良与选择的思考。
*   **触发方式：** 极低概率下，会有特殊的"访客猫咪"出现在咖啡馆门口，它们不点单，只是带着一段故事和一次选择。
*   **标志性事件案例：**
    *   **来自"无声山脉"的猫：**
        *   **象征：** 代表来自偏远、贫困地区的群体。
        *   **描述：** 一只毛发粗糙、眼神胆怯的猫咪，身上带着泥土，好奇又畏惧地看着店里的一切。它的内心气泡可能是："哇...这里好亮...好香...
        *   **选择：** 【赠送一杯热牛奶】 / 【温柔地抚摸它】 / 【假装没看见】。不同的选择会导向不同的反馈，比如获得一个名为"质朴的感谢"的稀有装饰品。
    *   **戴着"破碎铃铛"的猫：**
        *   **象征：** 代表经历过家园破碎、流离失所的群体。
        *   **描述：** 一只眼神忧郁的猫咪，脖子上挂着一枚裂开的铃铛，沉默地坐在角落。靠近它时，可能会触发一段无声的动画，展现它在美丽家园与家人玩耍，后家园被阴影吞噬的回忆。
        *   **选择：** 玩家可以选择消耗道具【万能胶水】为它【修复铃铛】，之后它会流着泪对主人鞠躬，并赠送一个名为"和平鸽羽毛"的绝版纪念品，然后悄然离开。
